# /hm-llm-guardrails — Patterns LLM-app (v1)
...
### 12. Tool calling guardrails (se aplicavel)
...
12. Tool calling guardrails: PASS/FAIL/N/A
...
- Pattern obrigatorio (1-9) faltando = bloqueante de producao
- Pattern recomendado (10-12) faltando = aceitavel pra MVP, technical debt
